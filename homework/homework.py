...
# Paso 1.
# Limpieza y reestructuración del dataset
...
# Paso 2.
# División datasets x_train, y_train, x_test, y_test.
...
# Paso 4.
# Optimización hiperparametros del pipeline usando validación cruzada.
...
# Paso 5.
# Guardar el modelo (comprimido con gzip) como "files/models/model.pkl.gz".
...
# Paso 7.
# Calcule las matrices de confusion
